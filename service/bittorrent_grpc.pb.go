...
type BitTorrentClient interface {
	Send(ctx context.Context, in *BitTorrent, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *bitTorrentClient) Send(ctx context.Context, in *BitTorrent, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type BitTorrentServer interface {
	Send(context.Context, *BitTorrent) (*empty.Empty, error)
...
func (*UnimplementedBitTorrentServer) Send(context.Context, *BitTorrent) (*empty.Empty, error) {
